...
pub const RENDEZVOUS_SERVERS: &[&str] = &["www.xiaochen.help"];
pub const RS_PUB_KEY: &str = "zSdpm76DdvtoUykK7burRsY2tWakhT2esWIqtgstn7c=";
...
mod tests {
    ...
    fn test_malformed_preset_password_with_salt_is_not_usable() {
        for storage in ["01secret", "00not-a-valid-hash"] {
            ...
            with_config_and_hard_settings(Config::default(),
